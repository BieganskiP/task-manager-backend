...
router.get("/verify/:verificationToken", async (req, res) => {
  try {
    ...
    // Remove the validation error by temporarily marking the field as optional
    user.schema.paths.verificationToken.isRequired = () => false;

    await user.save();

    // Restore the original validation rule
    user.schema.paths.verificationToken.isRequired = true;
